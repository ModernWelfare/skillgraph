...
public class SkillGraph
{
	...
	{
		List<String> itemInfo = QuickFileReader.readFile(itemToSkillMappingFilePath);
	...
	{
		List<String> guessSlipInfo = QuickFileReader.readFile(guessSlipFilePath);
	...
	{
		List<String> cptInfo = QuickFileReader.readFile(skillFilePath);
	...
	{
		List<String> cptInfo = QuickFileReader.readFile(guessSlipFilePath);
	...
	private void addSkillsToSkills(String skillStructureFilePath)
	{
		...
		List<String> structureInfo = QuickFileReader.readFile(skillStructureFilePath);
