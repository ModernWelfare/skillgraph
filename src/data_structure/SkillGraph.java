...
/**
 * Class that represents the graph generated from the given inputs
 * Note 1: All items belong to exactly one skill
 * Note 2: All skills have at least one item
...
public class SkillGraph
{
	...
	//typically they would be the same since we would want the skill indices to be in order
	...
	/**
	 * Function to store the skill cpt info in the bayes net into an appropriate data
	 * structure
	 * 
	 * @param cptInfoFilePath
	 */
	...
	/**
	 * Function to store the guess cpt info in the bayes net into an appropriate data
	 * structure
	 * 
	 * @param guessSlipFilePath
	 */
	...
	//super important to call after any additions or subtractions of skills in the graph
	...
	/*
	we should not hold the skill matrix as an array in this class
	since that would allow the possibility for it to be out of sync
	with the skill list.  Everytime we need a skill matrix we can call
	this function to generate it off of the current skill list
	*/
